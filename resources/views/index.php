...
<head>
	...
	<link rel="stylesheet" href="libs/styles/octicons.css">
	...
	<link rel="stylesheet" href="libs/styles/animate.css" />
	<link rel="stylesheet" href="libs/styles/leaflet.css" />
	...
	<link rel="stylesheet" href="libs/styles/angular-wizard.min.css">
	<link rel="stylesheet" href="libs/styles/pushy.css">
	<link rel="stylesheet" href="libs/styles/loading-bar.css">
	<link rel="stylesheet" href="libs/styles/angular-timeline.css" />
...
<script src='libs/js/ui-bootstrap.js'></script>
...
<script src='libs/js/angular-wizard.min.js'></script>
...
<script src="libs/js/pushy.js"></script>
<script src="libs/js/loading-bar.js"></script>
<script src="libs/js/angular-timeline.js"></script>
<script src="libs/js/angular-scroll-animate.js"></script>

<script src="libs/js/pushy.js"></script>
<script src="libs/js/angular-filter.min.js"></script>
<script src="https://cdn.socket.io/socket.io-1.1.0.js"></script>
<script src="libs/js/socket.js"></script>
